...
class AuthController extends Controller
{
    ...
    public function logout(Request $request)
    {
        ...
        try {
            ...
            return $this->helpers->response(true, $this->accepted, null, null, $this->acceptedCode);
        } catch (JWTException $exception) {

            return $this->helpers->response(false, $this->internalError, null, null, $this->internalErrorCode);
        }
    }
